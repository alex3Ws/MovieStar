...
public class FPeliculas_pendientes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       vista = inflater.inflate(R.layout.fragment_peliculas_pendientes, container, false);

       user_id = getArguments().getInt("user_id",0);

       recyclerViewPendientes = vista.findViewById(R.id.recycledViewPendientes);

        manager = new GridLayoutManager(getContext(), 2);
        recyclerViewPendientes.setHasFixedSize(true);
        recyclerViewPendientes.setLayoutManager(manager);
        ...
        recyclerViewPendientes.setAdapter(adapter);
        ...
        for(int i = 0; i<ids.size(); i++){
            ...
            jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(getContext(),"Error FPeliculas_pedientes",Toast.LENGTH_SHORT).show();
    ...
    public void onResume() {
        ...
        llamarApi();
        Toast.makeText(getContext(),"Pendientes - onResume", Toast.LENGTH_SHORT).show();
    }
}
